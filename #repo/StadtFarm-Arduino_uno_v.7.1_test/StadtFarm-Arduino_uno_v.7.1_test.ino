...
bool day_time = true;
bool switch_light_on = false;  // for additonal button to switch light on (maintenance ore else)
...
const int Capac_WaterValue_Full = 342;  // Limit for max Water level for filling
